...
We'll do a multiclassification with Type_1 as the response variable (18 levels) using MLR Package
...
```{r}
pokemontraintask=makeClassifTask(data = pokemon[trainsample,],target = "Type_1")
pokemontraintask
